...
public enum ConditionType {
    ...
    TARGET_ACTIVITY_COMPLETED_X_DAYS_BEFORE_DUE_DATE("TARGET_ACTIVITY_COMPLETED_X_DAYS_BEFORE_DUE_DATE"),
    TARGET_PROJECT_COMPLETED_X_DAYS_BEFORE_DUE_DATE("TARGET_PROJECT_COMPLETED_X_DAYS_BEFORE_DUE_DATE"),
