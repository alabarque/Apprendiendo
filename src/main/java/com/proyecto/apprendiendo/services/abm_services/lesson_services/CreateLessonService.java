...
public class CreateLessonService {
    ...
    public Long execute(LessonDTO lessonDTO) {
        Lesson lesson = Lesson.builder().name(lessonDTO.getName()).projectId(lessonDTO.getProjectId()).startDate(lessonDTO.getStartDate()).dueDate(lessonDTO.getDueDate()).build();
